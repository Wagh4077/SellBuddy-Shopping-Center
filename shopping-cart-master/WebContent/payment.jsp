...
<body style="background-color: #9e80ab;">
			...
			<form action="./OrderServlet" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						<img src="https://img.freepik.com/free-vector/realistic-credit-card-design_23-2149126091.jpg?semt=ais_hybrid&w=740" alt="Payment Proceed" height="100px" />
